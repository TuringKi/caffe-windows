...
namespace caffe{
	...
	template  SuncgDataLayer<float>::~SuncgDataLayer();
	template void SuncgDataLayer<float>::DataLayerSetUp(const vector<Blob<float>*>& bottom,
		const vector<Blob<float>*>& top);

	template void SuncgDataLayer<float>::load_batch(Batch<float>* batch);

	template  SuncgDataLayer<double>::~SuncgDataLayer();
	template void SuncgDataLayer<double>::DataLayerSetUp(const vector<Blob<double>*>& bottom,
		const vector<Blob<double>*>& top);

	template void SuncgDataLayer<double>::load_batch(Batch<double>* batch);
