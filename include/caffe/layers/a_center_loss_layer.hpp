#ifndef CAFFE_A_CENTER_LOSS_LAYER_HPP_
#define CAFFE_A_CENTER_LOSS_LAYER_HPP_
...
namespace caffe {
	...
	*/
	...
	class ACenterLossLayer : public Layer<Dtype> {
	public:
		explicit ACenterLossLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
		...
		virtual inline const char* type() const { return "ACenterLoss"; }
...
#endif  // CAFFE_A_CENTER_LOSS_LAYER_HPP_
