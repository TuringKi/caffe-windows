#ifndef CAFFE_CPM_HAND_DATA_TRANSFORMER_HPP
#define CAFFE_CPM_HAND_DATA_TRANSFORMER_HPP
...
namespace caffe {
	...
	*/
	...
	class CPMHandDataTransformer {
	public:
		explicit CPMHandDataTransformer(const CPMHandTransformationParameter& param, Phase phase);
		virtual ~CPMHandDataTransformer() {}
		...
		*/
		...
		void Transform_nv(const Datum& datum, Blob<Dtype>* 
			transformed_blob, Blob<Dtype>* transformed_label_blob, int cnt); //image and label
		/**
		* @brief Applies the transformation defined in the data layer's
		...
		*/
		...
		void ResizeToFixedSize(Mat& img, Mat& img_aug, MetaData& meta);
	...
	protected:
		...
		*/
		...
		CPMHandTransformationParameter param_;
...
#endif  // CAFFE_CPM_HAND_DATA_TRANSFORMER_HPP