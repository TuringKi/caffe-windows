...
#def squeeze_block(bottom, bottleneck):
...
def densenet(data_file, mode='train', batch_size=64, depth=40, first_output=64, growth_rate=32, dropout=0.2):
    ...
    model = L.Convolution(data, kernel_size=3, stride=2, num_output=nchannels,
