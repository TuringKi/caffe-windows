...
def stem_resnet_v2_299x299(bottom):
    ...
    conv_1x1_ave, conv_1x1_ave_relu = \
    ...
    return conv1_3x3_s2,conv1_3x3_relu, conv2_3x3_s1,  \
           conv2_3x3_s1_relu, conv3_3x3_s1, conv3_3x3_s1_relu, \
           pool1_3x3_s2, conv4_3x3_reduce, conv4_3x3_reduce_relu, \
           conv4_3x3,conv4_3x3_relu, pool2_3x3_s2, conv_1x1, \
           conv_1x1_relu, conv_5x5_reduce, conv_5x5_reduce_relu, \
           conv_5x5, conv_5x5_relu, conv_3x3_reduce, \
           conv_3x3_reduce_relu, conv_3x3, conv_3x3_relu, conv_3x3_2,  \
           conv_3x3_2_relu, ave_pool, conv_1x1_ave, conv_1x1_ave_relu, \
           concat
...
def inception_resnet_v2_a(bottom):
    ...
    return conv_1x1,  conv_1x1_relu, conv_3x3_reduce,  \
           conv_3x3_reduce_relu, conv_3x3,  conv_3x3_relu, \
           conv_3x3_2_reduce,  conv_3x3_2_reduce_relu, \
           conv_3x3_2,  conv_3x3_2_relu, conv_3x3_3, \
           conv_3x3_3_relu, concat, conv_up,  residual_eltwise, residual_eltwise_relu
...
def reduction_resnet_v2_a(bottom):
    ...
    return conv_3x3,  conv_3x3_relu, conv_3x3_2_reduce, \
           conv_3x3_2_reduce_relu, conv_3x3_2, \
           conv_3x3_2_relu, conv_3x3_3, conv_3x3_3_relu, pool, concat
...
def inception_resnet_v2_b(bottom):
    ...
    return conv_1x1, conv_1x1_relu, conv_1x7_reduce,  \
           conv_1x7_reduce_relu, conv_1x7,  conv_1x7_relu, \
           conv_7x1,  conv_7x1_relu, concat, conv_up,  \
...
def reduction_resnet_v2_b(bottom):
    ...
    return conv_3x3_reduce, conv_3x3_reduce_relu, conv_3x3, \
           conv_3x3_relu, conv_3x3_2_reduce,  \
            conv_3x3_2_reduce_relu, conv_3x3_2, \
           conv_3x3_2_relu, conv_3x3_3_reduce, conv_3x3_3_reduce_relu, \
           conv_3x3_3,  conv_3x3_3_relu, conv_3x3_4,  \
...
def inception_resnet_v2_c(bottom):
    ...
    return conv_1x1, conv_1x1_relu, conv_1x3_reduce, \
           conv_1x3_reduce_relu, conv_1x3,conv_1x3_relu, \
           conv_3x1, conv_3x1_relu, concat, conv_up,  \
           residual_eltwise, residual_eltwise_relu


string_a = 'n.inception_resnet_v2_a(order)_1x1,  \
        n.inception_resnet_v2_a(order)_1x1_relu, n.inception_resnet_v2_a(order)_3x3_reduce,\
        n.inception_resnet_v2_a(order)_3x3_reduce_relu, n.inception_resnet_v2_a(order)_3x3, \
        n.inception_resnet_v2_a(order)_3x3_relu, \
        n.inception_resnet_v2_a(order)_3x3_2_reduce,  \
        n.inception_resnet_v2_a(order)_3x3_2_reduce_relu, n.inception_resnet_v2_a(order)_3x3_2,  \
        n.inception_resnet_v2_a(order)_3x3_2_relu, n.inception_resnet_v2_a(order)_3x3_3, \
        n.inception_resnet_v2_a(order)_3x3_3_relu, \
        n.inception_resnet_v2_a(order)_concat, n.inception_resnet_v2_a(order)_up,  \
        n.inception_resnet_v2_a(order)_residual_eltwise, \
        n.inception_resnet_v2_a(order)_residual_eltwise_relu = \
            inception_resnet_v2_a(bottom)'

string_b = 'n.inception_resnet_v2_b(order)_1x1,  \
        n.inception_resnet_v2_b(order)_1x1_relu, n.inception_resnet_v2_b(order)_1x7_reduce,  \
        n.inception_resnet_v2_b(order)_1x7_reduce_relu, n.inception_resnet_v2_b(order)_1x7, \
        n.inception_resnet_v2_b(order)_1x7_relu, \
        n.inception_resnet_v2_b(order)_7x1,  \
        n.inception_resnet_v2_b(order)_7x1_relu, n.inception_resnet_v2_b(order)_concat, n.inception_resnet_v2_b(order)_up, \
        n.inception_resnet_v2_b(order)_residual_eltwise, \
        n.inception_resnet_v2_b(order)_residual_eltwise_relu \
            = inception_resnet_v2_b(bottom)'

string_c = 'n.inception_resnet_v2_c(order)_1x1,  \
        n.inception_resnet_v2_c(order)_1x1_relu, n.inception_resnet_v2_c(order)_1x3_reduce, \
        n.inception_resnet_v2_c(order)_1x3_reduce_relu, n.inception_resnet_v2_c(order)_1x3, \
        n.inception_resnet_v2_c(order)_1x3_relu, \
        n.inception_resnet_v2_c(order)_3x1,\
        n.inception_resnet_v2_c(order)_3x1_relu, n.inception_resnet_v2_c(order)_concat, n.inception_resnet_v2_c(order)_up, \
        n.inception_resnet_v2_c(order)_residual_eltwise, \
...
class InceptionResNet(object):
    ...
    def inception_resnet_v2_proto(self, batch_size, phase='TRAIN'):
        ...
        n.data, n.label = L.Data(source=source_data, backend=P.Data.LMDB, batch_size=batch_size, ntop=2,
                                 transform_param=dict(crop_size=160, mean_value=[104, 117, 123], mirror=mirror))

        # stem
        n.conv1_3x3_s2, n.conv1_3x3_relu, n.conv2_3x3_s1, \
        n.conv2_3x3_relu, n.conv3_3x3_s1, n.conv3_3x3_relu, \
        n.pool1_3x3_s2, n.conv4_3x3_reduce, n.conv4_3x3_reduce_relu, \
        n.conv4_3x3, n.conv4_relu_3x3, n.pool2_3x3_s2, n.conv5_1x1,\
        n.conv5_1x1_relu, n.conv5_5x5_reduce, n.conv5_5x5_reduce_relu, \
        n.conv5_5x5, n.conv5_5x5_relu, n.conv5_3x3_reduce, \
        n.conv5_3x3_reduce_relu, n.conv5_3x3, n.conv5_3x3_relu, n.conv5_3x3_2, \
        n.conv5_3x3_2_relu, n.ave_pool, n.conv5_1x1_ave, n.conv5_1x1_ave_relu, \
        n.stem_concat = stem_resnet_v2_299x299(n.data)  # 320x35x35

        # 10 x inception_resnet_v2_a
        type_a = 5
        for i in xrange(type_a):
            if i == 0:
        ...
        n.reduction_a_3x3, n.reduction_a_3x3_relu, \
        n.reduction_a_3x3_2_reduce, \
        n.reduction_a_3x3_2_reduce_relu, n.reduction_a_3x3_2,  \
        n.reduction_a_3x3_2_relu, n.reduction_a_3x3_3,  \
        n.reduction_a_3x3_3_relu, n.reduction_a_pool, n.reduction_a_concat = \
            reduction_resnet_v2_a(n.inception_resnet_v2_a5_residual_eltwise)  # 1088x17x17
        ...
        n.reduction_b_3x3_reduce,  \
        n.reduction_b_3x3_reduce_relu, n.reduction_b_3x3, \
        n.reduction_b_3x3_relu, n.reduction_b_3x3_2_reduce, \
        n.reduction_b_3x3_2_reduce_relu, n.reduction_b_3x3_2, \
        n.reduction_b_3x3_2_relu, n.reduction_b_3x3_3_reduce, \
        n.reduction_b_3x3_3_reduce_relu, n.reduction_b_3x3_3, \
        n.reduction_b_3x3_3_relu, n.reduction_b_3x3_4,  \
        n.reduction_b_3x3_4_relu, n.reduction_b_pool, n.reduction_b_concat = \
            reduction_resnet_v2_b(n.inception_resnet_v2_b10_residual_eltwise)  # 2080x8x8
        ...
        n.inception_resnet_v2_c10_1x1_relu = \
            factorization_conv_bn_scale_relu(n.inception_resnet_v2_c5_residual_eltwise, num_output=192,
                                             kernel_size=1)  # 192x8x8

        n.inception_resnet_v2_c10_1x3_reduce,\
        n.inception_resnet_v2_c10_1x3_reduce_relu = \
            factorization_conv_bn_scale_relu(n.inception_resnet_v2_c5_residual_eltwise, num_output=192,
                                             kernel_size=1)  # 192x8x8
        n.inception_resnet_v2_c10_1x3,  \
        ...
        n.inception_resnet_v2_c10_residual_eltwise = \
            L.Eltwise(n.inception_resnet_v2_c5_residual_eltwise, n.inception_resnet_v2_c10_up,
                      eltwise_param=dict(operation=1))  # 2080x8x8

        n.conv6_1x1, n.conv6_1x1_bn = \
